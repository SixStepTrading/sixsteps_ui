  ...
  return (
    <div>
      <div className="flex items-center gap-2">
        <p className={`font-medium text-sm ${isStockExceeded ? 'text-amber-500 dark:text-amber-400' : 'text-gray-900 dark:text-dark-text-primary'}`}>
          €{averagePrice.toFixed(2)}
        </p>
        
        {isStockExceeded && (
          <div className="group relative">
            <div className="inline-flex text-amber-500 dark:text-amber-400">
      ...
      <p className={`text-xs ${isStockExceeded ? 'text-amber-500 dark:text-amber-400' : 'text-gray-500 dark:text-dark-text-muted'}`}>
