...
import { deleteUserById, DeleteUserData } from '../../utils/api';
        ...
        <div className="inline-block w-full max-w-lg p-6 my-8 text-left align-middle transition-all transform bg-white dark:bg-gray-800 shadow-xl rounded-lg">
          ...
          <div className="mt-6">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-sm text-red-700 dark:text-red-300">
                    You are about to permanently delete the user <strong>{user.firstName} {user.lastName}</strong> ({user.email}). 
                    This will remove all their access and cannot be reversed.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg mb-6">
              <h5 className="text-sm font-medium text-gray-900 dark:text-white mb-3">User Details:</h5>
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-white">{user.associatedEntity}</p>
                </div>
              </div>
            </div>
